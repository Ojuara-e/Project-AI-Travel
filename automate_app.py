# Projeto4 - Deploy de App com Multi-Agentes de IA Para Planejamento de Viagens com CrewAI, Groq e Tavily
...
st.set_page_config(page_title = "Multi-Agentes AI", page_icon = ":100:", layout = "wide")
...
with st.sidebar:
    ...
    st.markdown("Projeto de Planejamento de viagens")
    ...
    # Valida se a cidade foi preenchida
        ...
        try:
            ...
            with st.spinner("Os Agentes de IA estão pesquisando e planejando sua viagem..."):
                ...
                equipe_agentes_ia = Crew(
                    
                    # Lista de agentes envolvidos
                    agents = [agente_guia_viagem, agente_planejador, agente_gerador_roteiro],
                ...
                result = equipe_agentes_ia.kickoff()
...
# Este é um projeto bem simples, mas que didaticamente ajuda a compreender o que são Agentes de IA.
